...
<?php
  ...
  mysqli_query($conexion, "insert into pru(nombres,apellidos,programa,n1,n2,n3,promedio,unidades,semestre) values ('$_REQUEST[nom]','$_REQUEST[apel]','$_REQUEST[codigocurso]',$_REQUEST[nota1],$_REQUEST[nota2],$_REQUEST[nota3],$pro,'$_REQUEST[uni]','$_REQUEST[sem]')") or die("Problemas en el select".mysqli_error($conexion));
