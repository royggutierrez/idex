...
a img:hover {
  ...
  <body>
  <!--Todo esto son os menús de botones-->
<div class="container">
 ...
 <!--Diseñando el formulario para el ngreso de datos-->
...
<!--estamos dentro del formulario para seleccionar el programa de estudios-->
    <div class="col-md-4 mb-3">
<label class="my-1 mr-2" for="inlineFormCustomSelectPref">Programas de Estudios</label>
  <select class="custom-select my-1 mr-sm-2" name="progra">
...
<!--estamos dentro del formulario para ingresar las notas-->
...
<!--estamos dentro del formulario para seleccionar la undiad didáctica-->
  ...
  <select class="custom-select my-1 mr-sm-2" name="uni">
    ...
    <!--estamos dentro del formulario para seleccionar el Semestre Académico -->
    <div class="col-md-3 mb-3">
...
<!--estamos dentro acepta si realmente se llenaron los campso de textos-->
